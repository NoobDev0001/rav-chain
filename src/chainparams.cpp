...
{
    const char* pszTimestamp = "The Times 03/Jan/2018 NASA lost it's firm value terribly";
...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x0"); // Block 2383567

        // By default assume that the signatures in ancestors of this block are valid. Block# 1040000
        consensus.defaultAssumeValid = uint256S("0x0"); // Block 2383560
        ...
        uint32_t nGenesisTime = 1664468049;
...
*/
        genesis = CreateGenesisBlock(nGenesisTime, 7560861, 0x1e00ffff, 4, 5000 * COIN);

        consensus.hashGenesisBlock = genesis.GetX16RHash();

        assert(consensus.hashGenesisBlock == uint256S("0x00000068cad72fd53b0926dfc52e5d5e66a2c4744c89ad603815097df2b125a8"));
        assert(genesis.hashMerkleRoot == uint256S("5e8b0e28c2a5e36463978329c1a71940e81d9a0785b153905830ccdefa270492"));
...
public:
    CTestNetParams() {
        ...
        uint32_t nGenesisTime = 1664382400;  // Thursday, September 20, 2018 12:00:00 PM GMT-06:00
...
*/
       /////////////////////////////////////////////////////////////////
        ...
        genesis = CreateGenesisBlock(nGenesisTime, 29495319, 0x1e00ffff, 2, 5000 * COIN);
        consensus.hashGenesisBlock = genesis.GetX16RHash();

        //Test MerkleRoot and GenesisBlock
        assert(consensus.hashGenesisBlock == uint256S("0x000000cb2fc0e95071ec9cd8524ae64fcc1d8f3208ada6ec78da0e6647f63781"));
        assert(genesis.hashMerkleRoot == uint256S("fc282244007114c3345eb3f578e6c3a8853a775cd7a80a389b9d0457b7cd14f4"));
        ...
        nKAAAWWWPOWActivationTime = 1664382400; //Wed Mar 25 2020 18:00:00 UTC
        nKAWPOWActivationTime = nKAAAWWWPOWActivationTime;
        /** RVN End **/
    }
};
